...
import { Recent } from 'assets/svgs';
...
const SearchRecentFilter: React.FC = () => {
  const recentSearches = useSelector((state: RootState) => state.app.Searches);

  return (
    <View style={styles.container}>
      <Text style={[styles.header, Font.semiBold]}>{i18n.t('recent')}</Text>
...
export default SearchRecentFilter;
